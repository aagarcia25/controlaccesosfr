...
export const setRfToken = (user: any) =>
  localStorage.setItem("Rftoken", JSON.stringify(user));
export const getRfToken = () => localStorage.getItem("Rftoken");
//IDAPP
export const setIdApp = (data: any) =>
  localStorage.setItem("idapp", JSON.stringify(data));
...
// PERMISOS
export const setPermisos = (permisos: any) =>
  localStorage.setItem("permisos", JSON.stringify(permisos));
export const getPermisos = () =>
  localStorage.getItem("permisos") === undefined
    ? []
...
//// foto perfil
export const setPerfilFoto = (perfiles: any) =>
  localStorage.setItem("perfilFoto", JSON.stringify(perfiles));
export const getPerfilFoto = () => localStorage.getItem("perfilFoto");
// DEPARTAMENTO
export const setDepartamento = (departamento: any) =>
